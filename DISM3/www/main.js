...
var routes = [
  {
    path: "home",
    loadChildren: () => import("./home.module-4GBBYIZ6.js").then((m) => m.HomePageModule)
  },
  {
    path: "",
    redirectTo: "home",
...
_AppModule.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({ providers: [{ provide: RouteReuseStrategy, useClass: IonicRouteStrategy }], imports: [
  BrowserModule,
  IonicModule.forRoot(),
  AppRoutingModule,
  HttpClientModule
